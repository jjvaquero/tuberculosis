...
FUNCTION view_bacile, n_imag, n_reg, CULTURE=culture, MARKED=marked, GREEN=green, $
	RET=ret
...
; bacilo
;
; im1 = view_bacile(3,23, CULTURE='21_09_01', /MARKED, /GREEN, /RET)
...
viewc, im_orig_frag, 0
view, im_mask_frag EQ n_reg, 1
IF KEYWORD_SET(green) THEN BEGIN
	view, REFORM(im_orig_frag[1,*,*]), 2
ENDIF
